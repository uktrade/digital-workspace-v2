...
class SectionPage(SearchFieldsMixin, BasePage):
    template = "content/section_page.html"
    ...
    sections = StreamField(
        [
            ("dw_section_card", dwds_blocks.SectionCardBlock()),
        ],
        blank=True,
    )
    ...
    useful_links = StreamField(
        [
            ("dw_curated_page_links", content_blocks.UsefulLinkBlock()),
        ],
        blank=True,
    )
