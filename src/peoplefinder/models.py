    ...
    class IndexManager(ModelIndexManager):
        ...
        def get_index_fields(cls):
            ...
            index_fields.update(
                ...
                preferred_first_name=IndexedField(
                ...
                contact_email=IndexedField(
                    "contact_email",
                    keyword=True,
                    boost=4.0,
                ),
                primary_phone_number=IndexedField(
                    "primary_phone_number",
                    keyword=True,
                    boost=4.0,
                ),
                secondary_phone_number=IndexedField(
                    "secondary_phone_number",
                    keyword=True,
                    boost=4.0,
                ),
                search_grade=IndexedField(
                    "search_grade",
                    explicit=True,
                ),
                search_buildings=IndexedField(
                    "search_buildings",
                    tokenized=True,
                ),
                roles=RelatedIndexedFields(
                    "roles",
                    [
                        IndexedField(
                            "job_title",
                ...
                key_skills=RelatedIndexedFields(
                    "key_skills",
                    [
                        IndexedField(
                            "name",
                ...
                learning_interests=RelatedIndexedFields(
                    "learning_interests",
                    [
                        IndexedField(
                            "name",
                ...
                additional_roles=RelatedIndexedFields(
                    "additional_roles",
                    [
                        IndexedField(
                            "name",
                ...
                international_building=IndexedField(
                    "international_building",
                    tokenized=True,
                ),
                search_location=IndexedField(
                    "search_location",
                    tokenized=True,
                ),
                fluent_languages=IndexedField(
                    "fluent_languages",
                    tokenized=True,
                ),
                search_teams=IndexedField(
                    "search_teams",
                    tokenized=True,
                    explicit=True,
                    boost=2.0,
                ),
                has_photo=IndexedField(
                    "has_photo",
                    proximity=True,
                    boost=1.5,
                ),
                profile_completion=IndexedField(
                    "profile_completion",
                    proximity=True,
                    boost=2.0,
                ),
                is_active=IndexedField(
                    "is_active",
                    filter=True,
                ),
                professions=IndexedField(
                    "professions",
                    filter=True,
                ),
                grade=IndexedField(
                ...
                # networks=IndexedField(
                #     "networks",
                #     filter=True,
                # ),
                do_not_work_for_dit=IndexedField("do_not_work_for_dit", filter=True),
            )
            return index_fields

    @classmethod
    def get_search_fields(cls):
        return cls.IndexManager(cls.search_fields)
