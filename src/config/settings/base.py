...
# Data flow
DATA_FLOW_UPLOADS_BUCKET = env("DATA_FLOW_UPLOADS_BUCKET", None)
DATA_FLOW_UPLOADS_BUCKET_PATH = env("DATA_FLOW_UPLOADS_BUCKET_PATH", None)
DATA_FLOW_DBT_SECTORS_DIRECTORY = env("DATA_FLOW_DBT_SECTORS_DIRECTORY", None)
DATA_FLOW_UK_OFFICE_LOCATIONS_DIRECTORY = env(
    "DATA_FLOW_UK_OFFICE_LOCATIONS_DIRECTORY", None
)
