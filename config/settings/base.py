...
MERGE_MAILCHIMP_RESULT_TEMPLATE_ID = env("MERGE_MAILCHIMP_RESULT_TEMPLATE_ID")
...
MAILCHIMP_TIMEOUT = int(env("MAILCHIMP_TIMEOUT"))
MAILCHIMP_SLEEP_INTERVAL = int(env("MAILCHIMP_SLEEP_INTERVAL"))
MAILCHIMP_UPDATE = env("MAILCHIMP_UPDATE", default=False)
